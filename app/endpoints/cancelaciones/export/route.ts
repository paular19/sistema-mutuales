...
import { exportCancelacionesAction } from "@/lib/actions/liquidaciones-cancelaciones-export";
...
export async function GET(req: Request) {
    try {
        ...
        const { buffer, filename, contentType } = await exportCancelacionesAction({
            format,
            productoId,
        });
        ...
        console.error("Error exportando cancelaciones:", error);
